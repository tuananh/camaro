...
type TransformResult<T> = T extends readonly [string, any] ? Mapped<T> : T extends Record<string, any> ? Transformed<T> : never;

export type XmlInput = string | Uint8Array | ArrayBuffer | Buffer;

export function prettyPrint(xml: XmlInput, opts?: { indentSize: number }): Promise<string>;
